...
public class ContactsFunctionNadia_StepDefs {
    ...
    @And("user enter full {string}")
    public void userEnterFull(String string) {
        BUtility.sleep(1);
        contactFunctionNadiaPage.contactsFullName.clear();
        BUtility.sleep(1);
        contactFunctionNadiaPage.contactsFullName.sendKeys(string);
        BUtility.sleep(1);
    ...
    public void userClicksOnThreeLinesButtonToDisplayContactTab() {
    ...
    public void userCanDeleteContactByClickingOnDeleteTab() {
        BUtility.waitFor(2);
        contactFunctionNadiaPage.deleteContact.click();
        BUtility.waitFor(2);
    ...
    public void userClickOnTheThreeDots() {
        contactFunctionNadiaPage.deleteContactThreedots.click();
    }
}